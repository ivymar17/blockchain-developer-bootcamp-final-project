...
//-->        
    ...
    AcceptRide = async event => {
        ...
        await this.state.ContractInstance.methods.acceptRide(time, fHex, tHex).send({from: account}).on('error', function(err, res) {
          if (err) {
            alert('The transaction failed.' + '\n' + 'Not the driver for the Ride.  or Ride is not requested yet. or You already accepted the Ride');             
            ...
            <>
                <div className="App-header" target="" >
                    <header className="Page-header">
                        <h1 className="Page-title">  Accept Ride </h1> 
                        <p>
                    ...
                    <form onSubmit={this.AcceptRide} className="">
                    <label htmlFor="time" className="Field-title">
                        ...
                        <br />
                        <br />
                        <button onClick={this.AcceptRide} className="Page-button"> Accept </button>
                    </form>
                </div>
            </>
        );
