...
class FetchRide extends Component { 
    constructor(props) {
        super (props);
    ...
    fetchRideCall = async event => { 
      ...
      const rideValueEvent = fetch.events.showRide.returnValues;
      console.log(fetch.events.showRide.returnValues[2]);
      const val_tok = 0.000177778 * 4500; //arbitrary value to set a currency 
      const fwToMt = Web3.prototype.fromWei((rideValueEvent[2] / val_tok), 'ether');
      const plateStr = Web3.prototype.toUtf8(rideValueEvent[1].toString());      
      alert('CAR PLATE: ' + plateStr + '\n' + 'FARE: ' + fwToMt);  
    };
            ...
            <>
                <div className="App-header" target="" >
                    <header className="Page-header">
                        <h1 className="Page-title"> Fetch Ride </h1>
                        <p>
                        Enter Ride to Fetch
                        </p>
                        <br />
                    ...
                    <form onSubmit={this.fetchRideCall} className="">
                        ...
                        <br />
                        <br />
                        <button className="Page-button"> Fetch </button>
                    </form>
                </div>
            </>
        );
